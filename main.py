...
def health():
    return {
        ...
        "mode": "direct-agent-orchestrator-fixed"
    }
...
async def run_audit(req: AuditRequest):
    ...
    try:
        ...
        # SYNTAX FIXED: Uses the correct threads namespace
        thread = client.agents.threads.create_thread()
        ...
        if run.status == "completed":
            # SYNTAX FIXED: Uses the correct threads namespace to fetch final content
